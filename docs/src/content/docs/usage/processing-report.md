...
description: "bismark report generates a graphical HTML report from a Bismark alignment report, optionally combining deduplication, methylation-extraction (splitting), M-bias and nucleotide-coverage reports."
---
