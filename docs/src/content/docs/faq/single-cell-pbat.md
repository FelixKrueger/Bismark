---
title: "Single cell PBAT"
description: "Bisulfite sequencing based on post-bisulfite adapter tagging (PBAT), including scBS-seq (single-cell Bisulfite-Seq) or scNMT-seq (single-cell nucleosome,…"
---
