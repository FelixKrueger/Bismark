...
| C | real-data byte-identity gate (**oxy**) → v1.0 tag | 📝 planned — **`IMPL_phase-C.md` written** (driver `nome_gate.sh` + matrix C1/C2/C3 + RELEASE checklist + tag); runs on **oxy** (Felix directive 2026-05-31; c2c Phase-E host), executed by Felix (remote data) |
