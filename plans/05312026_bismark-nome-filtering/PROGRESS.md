...
**Status:** ✅ COMPLETE — Phases A+B+C all GREEN; **tagged `bismark-nome-filtering-v1.0.0-beta.1`** + pushed
...
| C | real-data byte-identity gate (**oxy**) → v1.0 tag | ✅ **GREEN + RELEASED (2026-06-01)** — full 10M SE (10.29 GB `--yacht`) Perl≡Rust **byte-identical** (8,494,374 lines, md5 `7bdf7d5d…`; C2 gz-input PASS); Rust ~3.4× Perl; oxy crate tests green. **Tagged `bismark-nome-filtering-v1.0.0-beta.1`** + pushed; oxy purged. See `PHASE_C_RESULT.md`. |
