...
| 15 | Verify (dual `code-reviewer`) | ⏸ Awaiting user | Ask before spawning |
...
| 17 | Commit + PR → `dev` | ⏸ Awaiting user | Nothing committed — user reviews in a separate window first |
