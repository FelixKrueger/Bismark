...
//! ports stop re-deriving it. It is distinct from [`crate::cram_ref`] (which
...
///
/// Module-local (NOT a [`crate::error::BismarkIoError`] variant) so that adding
...
/// [`crate::cram_ref`] (noodles surfaces names up-to-first-whitespace).
#[derive(Debug)]
pub struct Genome {
