...
impl Tally {
    ...
    pub fn record(&mut self, bucket: crate::classify::Bucket) {
        match bucket {
            crate::classify::Bucket::AllMeth => self.all_meth += 1,
            crate::classify::Bucket::AllUnmeth => self.all_unmeth += 1,
            crate::classify::Bucket::Mixed => self.mixed += 1,
        }
    }
