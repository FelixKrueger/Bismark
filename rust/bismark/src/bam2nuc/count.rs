...
//! `calc_paired_end`), and tallies it via [`crate::bam2nuc::freqs::process_sequence`].
//!
...
use crate::bam2nuc::freqs::{self, NucCounts};
...
pub fn count_reads_in_file(
    ...
    let paired = crate::io::detect_paired_from_header(&header)
