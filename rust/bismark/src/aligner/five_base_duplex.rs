...
//! population pileup (as [`crate::aligner::five_base_deconv`] does): within one family, a
...
//! [`crate::aligner::five_base_deconv::StrandPileup`].
//!
//! ## SE limitation
//!
...
use crate::aligner::five_base_deconv::{CytosineVerdict, StrandPileup};
