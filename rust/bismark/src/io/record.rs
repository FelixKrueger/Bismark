...
//! [`crate::io::pair::BismarkPair`]'s `pair_strand()` rather than this
...
use crate::io::cigar::CigarExt;
use crate::io::error::BismarkIoError;
use crate::io::strand::BismarkStrand;
use crate::io::tags;
...
pub struct BismarkRecord {
    ...
    /// non-UMI path — readers constructed via [`crate::io::BamReader::new`]
...
impl BismarkRecord {
    ...
    /// [`crate::io::umi::extract_barcode`] or
    /// [`crate::io::umi::extract_bclconvert`]).
    ///
    ...
    /// should use [`crate::io::pair::BismarkPair::pair_strand`] instead.
    ...
    /// CIGAR string from the wrapped record. Use with [`crate::io::CigarExt`]
...
mod tests {
    ...
    fn from_noodles_record_with_umi_extracts_barcode_format() {
        let r = synth_with_qname(b"read:CTCCTTAG", b"CT", b"CT", b".....", b"ACGTC");
        let bm = BismarkRecord::from_noodles_record_with_umi(r, crate::io::umi::extract_barcode)
            .unwrap();
    ...
    fn from_noodles_record_with_umi_extracts_bclconvert_format() {
        ...
        let bm = BismarkRecord::from_noodles_record_with_umi(r, crate::io::umi::extract_bclconvert)
            .unwrap();
