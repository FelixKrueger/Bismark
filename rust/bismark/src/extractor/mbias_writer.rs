...
//! [`crate::extractor::pipeline::derive_basename`]: this one mirrors Perl's
...
use crate::extractor::call::CytosineContext;
...
///
/// **Differs from [`crate::extractor::pipeline::derive_basename`]**: that one strips
