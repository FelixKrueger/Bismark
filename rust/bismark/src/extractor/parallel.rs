...
use crate::extractor::call::{CytosineContext, MethCall, extract_calls};
...
/// legacy single-threaded [`crate::extractor::extract_se`] for any N.
...
enum ProducerReader {
    Any(crate::io::AnyReader<std::io::BufReader<std::fs::File>, std::fs::File>),
...
fn producer_loop(
    ...
    fn tick(logger: &crate::extractor::logging::Logger, lines_read: &mut u64) {
        *lines_read += 1;
