...
//!
//! The `(key, filename)` list comes from [`crate::extractor::output_mode::mode_keys`]
...
use crate::extractor::output_mode::{OutputKey, mode_keys, route_to_key, write_yacht_row};
...
impl OutputFileMap {
    ...
    ///
    /// `agg` is the optional in-memory `crate::bedgraph::Aggregator` (present
    ...
    pub fn write_call(
        ...
        yacht_col6: u32,
        yacht_col7: u32,
        agg: Option<&mut crate::bedgraph::Aggregator>,
        cx: bool,
...
mod tests {
    use super::*;
    use crate::extractor::cli::PairedMode;
    ...
    fn finalize_surfaces_kept_finish_error_via_result() {
        ...
        let result = map
            .finalize_with_empty_sweep(crate::extractor::logging::Logger::new(true, false), false);
        assert!(
            result.is_err(),
