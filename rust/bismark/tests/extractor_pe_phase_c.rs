...
use bismark::extractor::call::{CytosineContext, MethCall};
use bismark::extractor::cli::{Cli, PairedMode};
use bismark::extractor::overlap::{drop_overlap, is_forward_pair_strand};
use bismark::io::{BismarkPair, BismarkStrand};
use clap::Parser;
...
mod helpers {
    use bismark::io::{BismarkPair, BismarkRecord};
    use bstr::BString;
...
mod ignore_3prime_879 {
    use super::helpers;
    use bismark::extractor::call::{CytosineContext, MethCall};
    use bismark::extractor::overlap::drop_overlap;
