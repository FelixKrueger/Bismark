...
use bismark::extractor::call::{CytosineContext, MethCall, classify_xm_byte, extract_calls};
use bismark::extractor::cli::{Cli, OutputMode, ResolvedConfig};
use bismark::extractor::error::BismarkExtractorError;
use bismark::extractor::header::build_chr_name_table;
use bismark::extractor::mbias::{MbiasPos, MbiasTable};
use bismark::extractor::output::{
...
use bismark::extractor::route::route_call;
use bismark::extractor::state::ExtractState;
use bismark::io::{BismarkStrand, ReadIdentity};
use clap::Parser;
...
fn classify_xm_byte_classifies_all_six_methylation_bytes() {
    use bismark::extractor::call::XmClassification;
