...
//! Goldens in `tests/data/coverage2cytosine/phase_d/` are generated from the repo Perl v0.25.1.
...
fn pb() -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR")).join("tests/data/coverage2cytosine/phase_b")
}
fn pd() -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR")).join("tests/data/coverage2cytosine/phase_d")
}
