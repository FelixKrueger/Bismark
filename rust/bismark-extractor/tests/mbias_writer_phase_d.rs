...
use bismark_extractor::call::CytosineContext;
use bismark_extractor::mbias::{MbiasPos, MbiasTable};
use bismark_extractor::mbias_writer::{derive_mbias_basename, mbias_txt_path, write_mbias_txt};
...
mod finalize_integration {
    ...
    fn config_with(output_dir: &Path, mbias_off: bool) -> bismark_extractor::cli::ResolvedConfig {
